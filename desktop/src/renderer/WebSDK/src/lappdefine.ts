...
export let CurrentLipSyncParameterId = 'ParamMouthOpenY';
...
export function updateModelConfig(
  ...
  CurrentLipSyncParameterId = String(lipSyncParameterId || 'ParamMouthOpenY').trim() || 'ParamMouthOpenY';
