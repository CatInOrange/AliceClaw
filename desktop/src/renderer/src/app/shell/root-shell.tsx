          ...
          <>
            {latestUserMessage?.text ? (
              ...
              >
                ...
                <Text noOfLines={5} whiteSpace="pre-wrap" fontSize="12.5px" lineHeight="1.72" color="rgba(62, 57, 54, 0.88)">{latestUserMessage.text}</Text>
              </Box>
            ) : null}
            ...
            {latestAssistantMessage?.text ? (
              ...
              >
                ...
                <Text noOfLines={5} whiteSpace="pre-wrap" fontSize="12.5px" lineHeight="1.72" color="rgba(95, 72, 82, 0.92)">{latestAssistantMessage.text}</Text>
              </Box>
            ) : null}
          </>
        ) : null}
