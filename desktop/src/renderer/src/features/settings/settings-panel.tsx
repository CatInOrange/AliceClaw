...
import { useAppStore } from "@/runtime/app-store";
import { useLunariaRuntime } from "@/runtime/lunaria-runtime";
import { getLunariaScrollbarStyles } from "@/runtime/chat-shell-utils.mjs";
...
} from "@/runtime/settings-panel-utils.mjs";
import {
  lunariaColors,
  ...
  return (
    ...
    >
      ...
      <SettingsSection title={t("settings.sections.model")}>
        ...
        <select
          value={modelId}
          onChange={(event) => void runtime.switchModel(event.target.value)}
          style={sectionFieldStyle({ appearance: "none" })}
        >
            ...
            return (
              <Box key={`${currentProviderId}.${field.key}`}>
                ...
                <input
                  ...
                  onChange={(event) => runtime.setProviderFieldValue(currentProviderId, field.key, event.target.value)}
      ...
      <SettingsSection title={t("settings.sections.background")}>
        <input
          ...
          onChange={(event) => {
            ...
            if (file) {
              void runtime.setBackgroundFromFile(mode, file);
            }
            event.target.value = "";
          }}
        />
        <HStack gap="2" flexWrap="wrap">
          ...
          <Button size="sm" {...lunariaSecondaryButtonStyles} onClick={() => runtime.clearBackground(mode)}>{t("common.reset")}</Button>
        </HStack>
        <Text fontSize="12px" color={lunariaColors.textMuted}>
      ...
      <SettingsSection title={t("settings.sections.plugins")}>
        ...
        <Button size="sm" {...lunariaSecondaryButtonStyles} onClick={() => void runtime.refreshPlugins()}>
    ...
    <SettingsSection title={t("settings.sections.automation")}>
      ...
      <Box>
        ...
        <Stack mt="3" gap="3">
          ...
          <Textarea
            ...
            minH="100px"
          />
          <Button size="sm" {...lunariaSecondaryButtonStyles} onClick={() => void runtime.runAutomationProactive("manual")}>
      ...
      <Box>
        ...
        <Stack mt="3" gap="3">
          ...
          <Textarea
            ...
            minH="100px"
          />
          <Button size="sm" {...lunariaSecondaryButtonStyles} onClick={() => void runtime.runAutomationScreenshot("manual")}>
      ...
      <Box>
        ...
        <Stack mt="3" gap="3">
          ...
          />
          <Button size="sm" {...lunariaSecondaryButtonStyles} onClick={() => void runtime.stopAutomationMusic()}>
